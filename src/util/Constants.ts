...
export const Routes = {
	...
	messageReaction: (channelID: string, messageID: string, reaction: string): string => `/channels/${channelID}/messages/${messageID}/reactions/${reaction}`,
	messageReactionUser: (channelID: string, messageID: string, reaction: string, userID = '@me'): string => `/channels/${channelID}/messages/${messageID}/reactions/${reaction}/${userID}`,
